...
namespace MyProducts.AdminSite.Controllers
{
    public class CatagoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryId,CategoryName,CategoryDescription,CategoryActive")] Catagory catagory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryId,CategoryName,CategoryDescription,CategoryActive")] Catagory catagory)
        {
            if (ModelState.IsValid)
            {
